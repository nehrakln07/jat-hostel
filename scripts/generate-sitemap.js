...
"bikaner": [
  ...
  },
  {
    ...
    "data": '/assets/hostel/default.pdf',  
...
"nagaur": [
  ...
  },
  {
    ...
    "description": "Nagore",
    "imgSrc": '/assets/hostel/koliya-nagore.jpg',  //missing
    "data": '/assets/hostel/default.pdf', //missing
    // "href": "koliya-nagore",
    "href": "default",
    "status":  "working"
        ...
        <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
            ${pages
              .map((page) => {
                ...
                return `
                        <url>
                            <loc>https://rajasthanjathostel.com${route}</loc>
              ...
              ${DISTRICT.map((_d) =>{
                return `
                    <url>
                        <loc>https://rajasthanjathostel.com/hostels/${_d.url}</loc>
                        <changefreq>daily</changefreq>
                        <priority>0.7</priority>
                    </url>
                `
              }).join('')}
              ${TRUST_DISTRICT.map((_d) =>{
                return `
                    <url>
                        <loc>https://rajasthanjathostel.com/hostels/${_d.url}</loc>
                        <changefreq>daily</changefreq>
              ...
              ${Object.keys(projectsData).map((_d) =>{
                return projectsData[_d].map((_h)=>{
                  return `
                    <url>
                        <loc>https://rajasthanjathostel.com/trust/${_d}/${_h.id}</loc>
                        <changefreq>daily</changefreq>
                        <priority>0.7</priority>
                    </url>
                `
              ...
              ${Object.keys(trustData).map((_d) =>{
                return trustData[_d].map((_h)=>{
                  return `
                    <url>
                        <loc>https://rajasthanjathostel.com/trust/${_d}/${_h.id}</loc>
                        <changefreq>daily</changefreq>
